...
function getCartContent()
{
	...
	while ($row = dbFetchAssoc($result)) {
		if ($row['pd_thumbnail']) {
			$row['pd_thumbnail'] = 'http://localhost/plaincart/images/product/' . $row['pd_thumbnail'];
		} else {
			$row['pd_thumbnail'] = 'http://localhost/plaincart/images/no-image-small.png';
		}
		$cartContent[] = $row;
	}
...
function updateCart()
{
	$cartId     = $_REQUEST['hidCartId'];
	$productId  = $_REQUEST['hidProductId'];
