...
$pageTitle = 'MagicBox Online Shop';
...
<link href="http://localhost/plaincart/include/shop.css" rel="stylesheet" type="text/css">
<script language="JavaScript" type="text/javascript" src="http://localhost/plaincart/library/common.js"></script>
</head>
<body>